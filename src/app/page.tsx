    ...
    <>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-[4vh] lg:gap-0">
          ...
          <div className="px-[2vw] sm:px-[3vw] lg:px-[2vw] w-full lg:w-auto">
            ...
            <p className="text-center lg:text-right px-[2vw] sm:px-[3vw] lg:pl-[12vw] lg:px-[6vw] text-[1.8vh] sm:text-[2vh]">
              ...
              Côte d&apos;Azur, je travaille principalement avec Next.js,
              Payload CMS, Docker et PostgreSQL. Je porte une attention
              particulière à la qualité du code, à la sécurité des applications
              et à la performance. Je m&apos;intéresse également à Rust et à la
              cybersécurité, dans une démarche d&apos;amélioration continue.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        ...
        <p className="pb-[3vh] lg:pb-[5vh] pr-0 sm:pr-[8vw] lg:pr-[26vw] text-left text-[1.8vh] sm:text-[2vh]">
          ...
          Flite Watch. Travail axé sur la performance, le responsive et la
      ...
      >
        ...
        <p className="text-left sm:text-right pb-[3vh] text-[1.8vh] sm:text-[2vh]">
          Création du site temporaire &quot;Launching Soon&quot; pour Emma
          Zepter, avec intégration d&apos;un système d&apos;inscription à la
          newsletter via formulaire d&apos;email
        </p>
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-[4vh]">
          <div className="flex flex-col gap-[3vh] w-full lg:w-[40%]">
            ...
            <p className="text-[1.8vh] sm:text-[2vh]">
              ...
              permettant à l&apos;IA de connaître en temps réel les créneaux
              disponibles et de gérer automatiquement la prise de rendez-vous.
            </p>
            <p className="text-[1.8vh] sm:text-[2vh]">
            ...
            <ul className="list-disc list-inside text-[1.8vh] sm:text-[2vh] space-y-[0.5vh]">
              ...
              <li>
                Développement d&apos;une page de chat permettant aux
                utilisateurs de visualiser l&apos;historique des conversations
              </li>
              <li>
          ...
          <div className="w-full lg:w-[40%] text-justify flex flex-col gap-[3vh]">
            <p className="text-[1.8vh] sm:text-[2vh]">
              Participation au développement du dashboard SaaS de
              Rendez-vous.ai, une plateforme d&apos;automatisation des appels et
              de la prise de rendez-vous par IA.
            </p>
            <p className="text-[1.8vh] sm:text-[2vh]">
            ...
            <ul className="list-disc list-inside text-[1.8vh] sm:text-[2vh] space-y-[0.5vh]">
              ...
              <li>
                Stockage structuré des événements dans la base de données
                interne
              </li>
              <li>
        ...
        <div className="px-0 sm:px-[3vw] lg:px-[14vw] pt-[6vh] lg:pt-[10vh]">
          <p className="pb-[3vh] text-[1.8vh] sm:text-[2vh]">
            ...
            développement frontend, backend et infrastructure, sans recourir à
            des solutions clés-en-main, afin de garantir flexibilité, sécurité
            et maîtrise technique.
          </p>
          <p className="text-[1.8vh] sm:text-[2vh] mb-[2vh]">
            Ces réalisations s&apos;inscrivent dans le cadre plus large de
            Rendez-vous.ai, qui propose un agent vocal intelligent disponible
            24/7 pour automatiser la prise d&apos;appels et de rendez-vous.
          </p>
          <a
      ...
      >
        ...
        <div className="text-left sm:text-right pb-[8vh] lg:pb-[16vh] pl-0 sm:pl-[8vw] lg:pl-[24vw]">
          <p className="pb-[3vh] text-[1.8vh] sm:text-[2vh]">
            Développement complet du site e-commerce pour la maison de
            parfumerie Absolument Parfumeur.
          </p>
      ...
      >
        ...
        <h4 className="text-[1.8vh] sm:text-[2vh] lg:text-[2.2vh] mb-[3vh]">
          Vous avez un projet ou une question ? N&apos;hésitez pas à me
          contacter :
        </h4>
